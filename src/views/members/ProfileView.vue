  ...
  <div
    :class="
      store.getRole().role !== 'admin'
        ? 'py-3 px-4 lg:px-[50px] xl:px-32 mt-24'
        : 'px-4'
    "
  >
    <section :class="  store.getRole().role !== 'admin'?'text-gray-600 lg:mt-12 xl:mt-12 md:mt-12 mt-6':'h-[80vh] overflow-y-auto element-with-horizontal-scroll lg:px-2 xl:px-2 mt-5'">
      <div class="border-b rounded-bl-lg rounded-br-lg my-7">
        ...
        >
          ...
          <p
            ...
            :class="access ? 'text-gray-700' : 'text-[#D98757]'"
          >
      ...
      <div class="border-b rounded-bl-lg rounded-br-lg my-7">
        ...
        <p class="outfit-subtext border-x p-4">
          A QR code can be used as an acknowledgment tool to confirm the receipt
          of a budget. When funds are transferred, a unique QR code is generated
        ...
        <div class="flex items-center w-full border-x p-4">
          ...
          <div class="w-1/2 flex justify-center items-center">
            ...
            <div
              v-if="showQrcode"
              @click="closeQrcode"
              class="min-h-screen bg-gray-100 flex items-center justify-center fixed top-0 left-0 w-full z-30"
            >
              <div
